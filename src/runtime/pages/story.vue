...
<template>
	...
	>
		<aside
			class="nf-h-full nf-border-r nf-border-neutral-800/80 nf-bg-neutral-900 nf-pt-12 nf-transition lg:nf-relative lg:nf-inset-y-auto lg:nf-left-auto nf-flex nf-flex-col"
		>
		...
		<div
			class="group nf-relative nf-inset-y-0 nf-left-[-8px] nf-z-20 nf-w-4 nf-cursor-col-resize"
